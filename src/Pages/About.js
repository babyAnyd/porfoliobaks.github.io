  ...
  return (
    <div className="about-me">
      <section className="sec-1">
        ...
        <div className="sec-1-child">
          ...
          <p>
            ...
            Survey Programmer for Dynata. with a year of experience, I enjoy
            long walks on the beach, and I believe artificial intelligence will
      ...
      <section className="sec-1">
        ...
        <div className="sec-1-child">
          <p>
            <span className="span-green">vincentbaquiro $</span> cd skills/tools
          </p>
          <p>
